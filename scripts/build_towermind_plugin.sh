...
runtime="$project_dir/vendor/TowerMind/plugin_runtime/mac_apple_silicon/td.app/Contents/MacOS"
managed="$project_dir/vendor/TowerMind/plugin_runtime/mac_apple_silicon/td.app/Contents/Resources/Data/Managed"
bepinex="$runtime/BepInEx/core"
source_dir="$project_dir/plugin/TowerMind.Observer"
output_dir="$source_dir/bin/Release/netstandard2.0"
...
"$dotnet" "$compiler" \
    ...
    -deterministic+ \
    -optimize+ \
    -out:"$output_dir/TowerMind.Observer.dll" \
